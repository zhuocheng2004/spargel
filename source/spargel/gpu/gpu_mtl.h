...
sgpu_result sgpu_mtl_create_instance(sgpu_mtl_instance_id* instance, sgpu_instance_descriptor const* descriptor);
void sgpu_mtl_destroy_instance(sgpu_mtl_instance_id instance);
sgpu_result sgpu_mtl_create_default_device(sgpu_mtl_instance_id instance, sgpu_mtl_device_id* device);
