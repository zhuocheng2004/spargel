...
struct sgpu_operations {
  ...
  int (*create_shader_function)(sgpu_device_id,
                                struct sgpu_shader_function_descriptor const*,
                                sgpu_shader_function_id*);
  void (*destroy_shader_function)(sgpu_shader_function_id);
  int (*create_metal_shader_library)(
      sgpu_device_id, struct sgpu_metal_shader_library_descriptor const*,
