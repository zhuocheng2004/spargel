...
AppDelegateMac::AppDelegateMac(sui_window_id window) { _window = window; }
...
uint32_t AppDelegateMac::GetWidth() { return _window->window.frame.size.width; }
uint32_t AppDelegateMac::GetHeight() { return _window->window.frame.size.height; }
