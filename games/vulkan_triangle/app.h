...
private:
    ...
    void BeginRenderPass(VkCommandBuffer cmd, uint32_t image_id, VkClearColorValue clear);
    ...
    static VkBool32 DebugMessageCallback(VkDebugUtilsMessageSeverityFlagBitsEXT severity,
